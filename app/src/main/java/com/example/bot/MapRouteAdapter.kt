...
class MapRouteAdapter(private val routes: Array<DirectionsRoute>) : RecyclerView.Adapter<MapRouteAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.durationTextView.text = "Distance: ${ItemsViewModel.legs.sumOf { it.distance.inMeters } / 1000.0} km \nDuration: ${ItemsViewModel.legs.sumOf { it.duration.inSeconds } / 60} mins"
